...
ActiveRecord::Schema[7.0].define(version: 2023_06_23_145253) do
  ...
  create_table "entities", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "credits"
    t.boolean "request_in_progress", default: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "accepted_eula_on"
    t.datetime "accepted_cookies_on"
    t.datetime "accepted_privacy_on"
    t.datetime "saw_banner_on"
  end
