    ...
    class UpdateEntity < ::Mutations::BaseMutation
      ...
      def resolve(id:, **attributes)
        ...
        if attributes.keys.include?(:credits)
          ...
          raise GraphQL::ExecutionError, "Incorrect execution.new#{attributes[:credits]} old #{current_credits}" unless current_credits.to_f > attributes[:credits].to_f || context[:admin_request] 
