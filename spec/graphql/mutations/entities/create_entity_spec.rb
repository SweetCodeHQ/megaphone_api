    ...
    RSpec.describe CreateEntity, type: :request do
      describe '.resolve' do
        it 'creates an entity' do
          ...
          expect do
            post '/graphql', params: { query: g_query(url: "widget.com", name: "Widget") }, headers: { authorization: ENV['EAGLE_KEY'] }
          end.to change { Entity.count }.by(1)
        end

        it 'returns an entity' do
          post '/graphql', params: { query: g_query(url: "wide.com", name: "Wide") }, headers: { authorization: ENV['EAGLE_KEY'] }
